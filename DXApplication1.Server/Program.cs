...
builder.Services.ConfigureReportingServices(configurator =>
{
    ...
    configurator.ConfigureReportDesigner(designerConfigurator =>
    {
        ...
        // NOTE: Data source wizard buttons are hidden via the frontend CustomizeMenuActions callback
        // in ReportDesigner.tsx. DevExpress 25.2.x does not expose DataSourceWizardSettings on the
        // ReportDesignerConfigurationBuilder. The frontend approach using action.visible = false
        // effectively hides the buttons from users.
    });
